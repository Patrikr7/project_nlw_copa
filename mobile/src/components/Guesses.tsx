...
export function Guesses({ poolId, code, onShare }: Props) {
  ...
  async function fetchGames() {
    try {
      ...
      toast.show({
        title: 'Opss!',
        description: "Não foi possível recuperar os dados dos jogos. Por favor, tente novamente.",
        placement: 'top',
        bgColor: 'red.500',
      });
    } finally {
  ...
  async function handleGuessConfirm(gameId: string) {
    ...
    try {
      ...
      toast.show({
        title: 'Opss!',
        description: "Não foi possível completar o palpite. Por favor, tente novamente.",
        placement: 'top',
        bgColor: 'red.500',
      });
    } finally {
